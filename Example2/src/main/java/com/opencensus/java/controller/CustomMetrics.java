...
public class CustomMetrics {
    ...
    private static final View view = View.create(View.Name.create("HitCount"),
            "The Count of RestRequest",
            M_COUNT, Aggregation.Count.create(),
            Collections.singletonList(TagKey.create("HitCount")));

    private static void recordStat(Measure.MeasureLong ml, Long n) {
        TagContext tctx = tagger.currentBuilder().put(TagKey.create("HitCount"),
                TagValue.create("Count of Hits made to Rest Endpoint")).build();
...
*/
    ...
    @RequestMapping(value = "/customMetricEndpoint", method = RequestMethod.GET)
